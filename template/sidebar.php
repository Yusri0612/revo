          ...
          <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
              ...
              <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                  <ul class="nav flex-column"> 
                      <li class="nav-item"> 
                          <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?= $main_url ?>dashboard/dashboard.php">
  ...
  Dashboard
      ...
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>user">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="curren tColor" class="bi bi-person" viewBox="0 0 16 16">
  ...
  mb-1 text-body-secondary text-uppercase"> 
  <span>Data</span>
  </h6> 
  ...
  <ul class="nav flex-column mb-auto"> 
      <li class="nav-item"> 
          <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>data/rekam/index.php">
  ...
  <li class="nav-item">
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>data/dokter/index.php"> 
  ...
  <li class="nav-item"> 
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>data/obat/index.php"> 
  ...
  <li class="nav-item">
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>data/pasien/index.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
    <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4"/>
  </svg>
  Pasien
  ...
  <ul class="nav flex-column mb-auto"> 
      <li class="nav-item"> 
          <a class="nav-link d-flex align-items-center gap-2"  href="<?= $main_url ?>laporan/kunjungan/index.php">
  ...
  <li class="nav-item">
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>laporan/tindakan/index.php"> 
          <svg class="bi" aria-hidden="true">
  ...
  <li class="nav-item"> 
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>tempat/poli/index.php"> 
  ...
  <li class="nav-item">
      <a class="nav-link d-flex align-items-center gap-2" href="<?= $main_url ?>tempat/lab/index.php">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
    <path d="M4 2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zm3.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zM4 5.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zM7.5 5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm2.5.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zM4.5 8a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm2.5.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zm3.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5z"/>
    <path d="M2 1a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1zm11 0H3v14h3v-2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V15h3z"/>
  </svg>
